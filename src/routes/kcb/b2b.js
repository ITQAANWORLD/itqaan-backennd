    ...
    try {
        ...
        const payload = {
            "header": {
                ...
                "routeCode": "202",
                "timestamp": "1095379199.75"
              },
              "requestPayload": {
                "transactionInfo": {
                  "transactionID": "FT20114BG840",
                  "transactionType": "1"
                },
                "additionalDetails": {
                  "keyOwner": "1",
        ...
        const base_url = "https://uat.buni.kcbgroup.com/businesTransfers/b2b/1.0.0"
